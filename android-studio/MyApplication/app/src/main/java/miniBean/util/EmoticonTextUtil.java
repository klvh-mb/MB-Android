...
public class EmoticonTextUtil {
    ...
    static {
        ...
        iconsMap.put("0:)", R.drawable.emo_angel);
        //iconsMap.put("/assets/app/images/emoticons/bad.png", R.drawable.emo_bad);
        iconsMap.put(":$", R.drawable.emo_blush);
        iconsMap.put("|;-)", R.drawable.emo_cool);
        iconsMap.put(":'(", R.drawable.emo_cry);
        //iconsMap.put("/assets/app/images/emoticons/dry.png", R.drawable.emo_dry);
        iconsMap.put(":(", R.drawable.emo_frown);
        //iconsMap.put("/assets/app/images/emoticons/gasp.png", R.drawable.emo_gasp);
        iconsMap.put(":-D", R.drawable.emo_grin);
        iconsMap.put(":)", R.drawable.emo_happy);
